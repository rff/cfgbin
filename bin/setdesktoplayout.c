/* raoni: taken from openbox.org FAQ page. It is a micro pager  to set desktop layout ^^.
 * url: http://openbox.org/wiki/Help%3aFAQ#How_do_I_put_my_desktops_into_a_grid_layout_instead_of_a_single_row.3F
 * src: http://icculus.org/openbox/tools/setlayout.c
 */
